...
<head>
    ...
    <script src="../script/query-3.7.1.min.js"></script>
        ...
        <?php
            ...
            if (!empty($annuaire)) {
                ...
                foreach($annuaire as $ligne) {
                    ...
                    echo '<td> 
                        <button name="remove" value="' . $ligne->id_annauire . '">Supprimer</button>
                        <button name="modify" value="' . $ligne->id_annauire . '">Modifier</button> 
                        </td>';                
                ...
                if (isset($_POST) && !empty($_POST)) {
                    if (!empty($_POST['remove'])) {
                        ...
                        header("Location: edit.php?id_annauire=" . $_POST['modify']);
                    }
                }
            }
