...
<head>
    ...
    <script src="../../script/jquery-3.7.1.min.js
    "></script>
    <link rel="stylesheet" href="style.css">
    <title>nav-bar2</title>
</head>
<body>
<nav>
        <div class="hidden">        
        ...
        <div> 
            <box-icon name="github" type="logo" color="#fff" size="30px" class="hidden"></box-icon>
            <box-icon name="menu" id="menu" color="#fff" size="30px" class="hidden"></box-icon>
            <box-icon name='x' color='#fefefe' ></box-icon>
        </div>
    </nav>
    <script>
        $('#menu').click(function(){
